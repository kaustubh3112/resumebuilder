  ...
  return (
    <>
      <form className='w-full mb-5' onSubmit={expFormHandler} noValidate>
        <h4 className='text-white text-lg mb-3'>Experince : </h4>
        <div className='mb-5'>
          <input
            name='company'
      ...
      <p className='text-white'>{expData.company}</p>
      <p className='text-white'>{expData.location}</p>
      <p className='text-white'>{expData.joiningDate}</p>
      <p className='text-white'>{expData.resigningDate}</p>
      <p className='text-white'>{expData.description}</p>
    </>
  )
}
